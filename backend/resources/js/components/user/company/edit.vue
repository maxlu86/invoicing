              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Update User's Company</h1>
                  </div>
                    <form class="user" @submit.prevent="userCompanyUpdate" enctype="multipart/form-data">

                        <div class="form-group form-row">
                            <div class="col-md-2">
                                <img :src="'http://localhost:8002/'+form.logo" style="height: 50px; width: auto;"> 
...
<script type="text/javascript">
  export default {
    ...
    methods:{
        userCompanyUpdate() {
            let id = this.$route.params.id
            axios.patch('/api/user/company/'+id, this.form)
            .then(() => {
