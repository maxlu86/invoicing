...
<head>
  ...
  <link href="{{ asset('backend/img/logo/logoTP.png')}}" rel="icon">
  <title>Invoicing APP - Dashboard</title>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="{{ asset('backend/img/logo/logoTP.png')}}">
        </div>
        <div class="sidebar-brand-text mx-3">Invoicing APP</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link to="" class="collapse-item" href="buttons.html">Offers</router-link>
            <router-link to="" class="collapse-item" href="dropdowns.html">Proforma invoices</router-link>
          </div>
        </div>
      </li>
      <li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-white small">Maksim</span>
              </a>
